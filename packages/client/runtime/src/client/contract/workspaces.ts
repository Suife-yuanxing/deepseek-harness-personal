...
export interface IWorkspaces {
  ...
  /**
   * Remove a session from the registry-global archive set (unarchive). The
   * session rejoins its kept workspace accounting slot. Idempotent for a
   * non-archived or unknown id.
