...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({
    ...
    details: z.object({
      ...
      requestedAdditionalRoots: z.array(z.string()).optional(),
      existingAdditionalRoots: z.array(z.string()).optional(),
    }),
  }),
  z.object({ code: z.literal('federation-disabled'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('federation-invalid-members'), message: z.string(), details: z.object({ path: z.string() }) }),
  ...
  z.object({ code: z.literal('federation-not-found'), message: z.string(), details: z.object({ federationId: z.string() }) }),
  z.object({ code: z.literal('federation-name-conflict'), message: z.string(), details: z.object({ title: z.string() }) }),
