...
describe('rowToMeta', () => {
  ...
  it('restores the session’s additional roots from their JSON encoding', () => {
    expect(rowToMeta({
      id: 'with-roots',
      version: 0,
      created_at: 1,
      ...
      seed_length: null,
      origin: null,
      incarnation: 'with-roots',
      revision: 1,
      delegation_depth: null,
      agent_preset: null,
      additional_roots: JSON.stringify(['/fed-b', '/fed-c']),
    })).toMatchObject({ additionalRoots: ['/fed-b', '/fed-c'] })
  })
})
